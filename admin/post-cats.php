    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">دسته بندی نوشته ها</h1>
            ...
            <section class="event-gift-section padding-tb padding-b bg-image">
                <div style="text-align: center">
                    <form action="post-cats.php" method="post">
                        <input type="text" name="post-cat-name" placeholder="نام دسته بندی" style="width: 50%">
                        <input type="submit" name="add-post-cat" value="افزودن دسته جدید">
                    </form>
                </div>
